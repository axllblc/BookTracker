 ...
 */
final class Version20231211143751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE author (id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, birth_day DATE DEFAULT NULL, death_date DATE DEFAULT NULL, picture VARCHAR(255) DEFAULT NULL, last_edit_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, added_by_id INT DEFAULT NULL, last_edit_by_id INT DEFAULT NULL, genre_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, isbn VARCHAR(13) DEFAULT NULL, publication DATE DEFAULT NULL, cover_picture VARCHAR(255) DEFAULT NULL, editor VARCHAR(255) DEFAULT NULL, added_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_edit_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE contact (id INT NOT NULL, username VARCHAR(50) DEFAULT NULL, email VARCHAR(180) NOT NULL, subject VARCHAR(100) DEFAULT NULL, message TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, user_id INT DEFAULT NULL, book_id INT DEFAULT NULL, emotion_id INT DEFAULT NULL, review TEXT DEFAULT NULL, score INT DEFAULT NULL, visible BOOLEAN DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
